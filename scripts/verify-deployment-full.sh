## current version: verifydeploymentbashv18

## Heres the all-in-one deployment verification script 
## to also generate an interactive HTML dashboard 
## and save it inside the scripts/ folder
